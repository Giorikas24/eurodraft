...
export default function Login() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center" style={{ fontFamily: "'Arial Black', Impact, sans-serif" }}>
      ...
      >
        {/* Header */}
        <div className="bg-[#ff751f] px-6 py-5 text-center">
          <a href="/" className="inline-flex items-center gap-0 mb-2">
            <div className="bg-black px-2.5 py-1.5">
              <span className="text-[#ff751f] font-black text-base tracking-tighter">COURT</span>
            </div>
            <div className="bg-white px-2.5 py-1.5">
              <span className="text-black font-black text-base tracking-tighter">PROPHET</span>
            </div>
          </a>
          <p className="text-black/70 text-[10px] font-black uppercase tracking-widest mt-2">Σύνδεση στον λογαριασμό σου</p>
        </div>
        ...
        <div className="p-6 flex flex-col gap-4">
          ...
          <p className="text-center text-[10px] text-gray-600 font-black uppercase tracking-widest" style={{ fontFamily: "Arial, sans-serif" }}>
            ...
            <a href="/auth/register" className="text-[#ff751f] hover:underline">Εγγραφή</a>
          </p>
        </div>
      </motion.div>
    </main>
